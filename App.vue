<script>
  ...
  uni.$showMsg = function(tit, ico="none") {
    uni.showToast({
          title: tit,
          icon: ico
    })
...
<style>
  ...
  .swiperOut .uni-swiper-wrapper {
    border-radius: 7%;
  }
  .moni-search .uni-searchbar__box {
      border: 1px solid #DEDEEA;
  }
  .pop-container .uni-input-input,.pop-container .uni-textarea-textarea {
      color: #000;
    }
</style>
